...
To enable the operator to utilize the cert-manager for automated webhook certificate management, ensure that it is installed in the cluster. Use this guide to install cert-manager if not present on the cluster.
