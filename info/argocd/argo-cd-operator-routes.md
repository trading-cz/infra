...
It is not recommended to use .route.tls.key & .route.tls.certificate fields to configure custom certificates for Argo CD routes. Use .route.tls.externalCertificate field instead. Refer Custom TLS certificates section for more information.
